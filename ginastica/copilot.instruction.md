...
---
Ginasticas
Plano de Aula Fev-Mar
10' Caminhada
Agachamento sumô (3 x 40")
Afundo alternado (3 x 40")
Stiff (3 x 40")
Panturrilhas — insistindo 3x (3 x 40")
Remada curvada supinada (4 x 40")
Rosca direta unilateral + bilateral (4 x 40")
Elevação frontal + lateral
Pullover + Crucifixo alternado lado (Flexão na parede)
Abdominal oblíquo (Sentado, alternando pernas e braços)
Extensão de quadril (Em pé)
Alongamentos finais
cada exercício tem 40 segundos de execução, com 20 segundos de descanso entre eles. O plano é para ser realizado 3 vezes por semana, durante os meses de fevereiro e março. Lembre-se de manter uma boa postura durante os exercícios e ajustar a intensidade conforme necessário para evitar lesões.
em cada exercício,   coloque  um video do youtube para exemplificar a execução correta. Certifique-se de assistir aos vídeos antes de realizar os exercícios para garantir que você está fazendo-os corretamente e com segurança. Se sentir qualquer desconforto ou dor, pare imediatamente e consulte um profissional de saúde. Boa sorte com seu plano de aula e aproveite seus treinos!
---
